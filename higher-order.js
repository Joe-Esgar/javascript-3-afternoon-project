...
//array.filter(function(val, i, arr){
//return WHATEVER CONDITION TRUE OR FALSE
//}
//
...
//Code Here
let totalPopulation = populations.reduce(function(acc, value, index, array) {
  return acc + value;
});
...
*/
let reduceFn = function(total, element, index, array) {
...
let bobsTotal = purchases.reduce(reduceFn, 0);
